...
* [🧠 Concepts](x-badges/concepts/README.md)
  ...
  * [Approval Criteria 2](x-badges/concepts/approval-criteria-2/README.md)

  * [Approval Criteria 3](x-badges/concepts/approval-criteria-3/README.md)

  * [Permission System](x-badges/concepts/permissions/README.md)
    ...
    * [Badge ID Action Permissions](x-badges/concepts/permissions/badge-id-permissions.md)
...
* [💡 Examples and Snippets](x-badges/examples/README.md)
  ...
  * [Permission Examples](x-badges/examples/permissions/README.md)
    ...
    * [Locking Specific Badge IDs](x-badges/examples/permissions/locking-specific-badge-ids.md)
    * [Locking Valid Badge IDs](x-badges/examples/permissions/locking-valid-badge-ids.md)
  * [Transaction Examples](x-badges/examples/txs/README.md)
    * [MsgCreateCollection Examples](x-badges/examples/txs/msgcreatecollection/README.md)
      * [Quest Badge Collection Example](x-badges/examples/txs/msgcreatecollection/quest-badge-collection.md)

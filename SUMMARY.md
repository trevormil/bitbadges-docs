...
* [🏗️ BitBadges Claims](overview/claim-builder/README.md)
  ...
  * [Created Plugins](for-developers/claim-builder/bitbadges-created-plugins/README.md)
    * [Plugins Directory](https://bitbadges.io/plugin-directory)
    * [Plugin References](for-developers/claim-builder/bitbadges-created-plugins/plugin-references.md)
    * [Number of Uses](for-developers/claim-builder/bitbadges-created-plugins/number-of-uses.md)
    * [Socials / Email Plugins](for-developers/claim-builder/bitbadges-created-plugins/authentication-based-plugins.md)
    ...
    * [IP Restrictions](for-developers/claim-builder/bitbadges-created-plugins/ip-restrictions.md)
    * [Geolocation](for-developers/claim-builder/bitbadges-created-plugins/geolocation.md)

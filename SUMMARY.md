...
* [📚 BitBadges API](for-developers/bitbadges-api/README.md)
  ...
  * [Sign In with BitBadges](for-developers/bitbadges-api/sign-in-with-bitbadges/README.md)
    * [Overview](for-developers/bitbadges-api/sign-in-with-bitbadges/overview.md)
    * [Templates and Frameworks](for-developers/bitbadges-api/sign-in-with-bitbadges/templates-and-frameworks/README.md)
      * [WordPress](for-developers/bitbadges-api/sign-in-with-bitbadges/templates-and-frameworks/wordpress.md)
      * [Auth0](for-developers/bitbadges-api/sign-in-with-bitbadges/templates-and-frameworks/auth0.md)
      * [ExpressJS](for-developers/bitbadges-api/sign-in-with-bitbadges/templates-and-frameworks/expressjs.md)
      * [Discourse](for-developers/bitbadges-api/sign-in-with-bitbadges/templates-and-frameworks/discourse.md)
      * [Supabase](for-developers/bitbadges-api/sign-in-with-bitbadges/templates-and-frameworks/supabase.md)
      * [Others](for-developers/bitbadges-api/sign-in-with-bitbadges/templates-and-frameworks/others.md)
    * [Setting Up an App](for-developers/bitbadges-api/sign-in-with-bitbadges/setting-up-an-app.md)
    * [Authorization URL](for-developers/bitbadges-api/sign-in-with-bitbadges/authorization-url/README.md)
      * [Configuration](for-developers/bitbadges-api/sign-in-with-bitbadges/authorization-url/configuration.md)
      * [Generating the URL](for-developers/bitbadges-api/sign-in-with-bitbadges/authorization-url/generating-the-url.md)
    * [Approaches](for-developers/bitbadges-api/sign-in-with-bitbadges/approaches/README.md)
      * [QR Codes](for-developers/bitbadges-api/sign-in-with-bitbadges/approaches/qr-codes.md)
      * [Redirect Callback](for-developers/bitbadges-api/sign-in-with-bitbadges/approaches/redirected-callback.md)
    * [Verification](for-developers/bitbadges-api/sign-in-with-bitbadges/verification/README.md)
      * [Verification Flow](for-developers/bitbadges-api/sign-in-with-bitbadges/verification/verification-flow.md)
      * [Access Tokens](for-developers/bitbadges-api/sign-in-with-bitbadges/verification/access-tokens.md)
      * [Offline Verification](for-developers/bitbadges-api/sign-in-with-bitbadges/verification/offline-verification.md)
      * [Security Considerations](for-developers/bitbadges-api/sign-in-with-bitbadges/verification/security-considerations.md)
...
* [👤 Multi-Chain Accounts](token-standard/accounts.md)

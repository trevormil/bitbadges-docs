...
* [🖱️ Sign In with BitBadges](for-developers/authenticating-with-bitbadges/README.md)
  ...
  * [Add-Ons](for-developers/sign-in-with-bitbadges/add-ons/README.md)
    * [Extending with Zapier](for-developers/sign-in-with-bitbadges/add-ons/spreadsheet-session-management.md)
    * [Badge-Gating Discord Servers](for-developers/sign-in-with-bitbadges/add-ons/badge-gating-discord-servers.md)
  * [Other Tutorials](for-developers/sign-in-with-bitbadges/other-tutorials.md)

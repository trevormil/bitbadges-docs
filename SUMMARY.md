...
* [🧠 Core Concepts](for-developers/core-concepts/README.md)
  ...
  * [🗝️ Verifiable Secrets](for-developers/core-concepts/verifiable-secrets/README.md)
...
* [🖱️ Sign In with BitBadges](for-developers/sign-in-with-bitbadges/README.md)
  * [Authentication URL + Parameters](for-developers/sign-in-with-bitbadges/authentication-url-+-parameters/README.md)
    * [Challenge Parameters](for-developers/sign-in-with-bitbadges/authentication-url-+-parameters/challenge-parameters.md)
  * [Approaches](for-developers/sign-in-with-bitbadges/approaches/README.md)
    * [Manual](for-developers/sign-in-with-bitbadges/approaches/manual.md)
    * [Sign In with BitBadges Callback](for-developers/sign-in-with-bitbadges/approaches/sign-in-with-bitbadges-callback.md)
    * [Self-Implemented Callback](for-developers/sign-in-with-bitbadges/approaches/self-implemented-callback.md)
  * [Verification](for-developers/sign-in-with-bitbadges/verification.md)
  * [Other Tutorials](for-developers/sign-in-with-bitbadges/other-tutorials/README.md)
    * [Spreadsheet Session Management](for-developers/sign-in-with-bitbadges/other-tutorials/spreadsheet-session-management.md)
    * [Badge-Gating Discord Servers](for-developers/sign-in-with-bitbadges/other-tutorials/badge-gating-discord-servers.md)

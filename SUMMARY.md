...
* [📖 Concepts](x-tokenization/concepts/README.md)
  * [Approval Change Events and Review Items](x-tokenization/concepts/approval-change-events.md)
...
* [🤖 MCP Builder Skills](x-tokenization/examples/skills/README.md)
  ...
  * [Fungible Token](x-tokenization/examples/skills/fungible-token.md)
  * [NFT Collection](x-tokenization/examples/skills/nft-collection.md)
  * [Subscription](x-tokenization/examples/skills/subscription.md)
  * [Transferability & Update Rules](x-tokenization/examples/skills/immutability.md)
  * [Custom 2FA](x-tokenization/examples/skills/custom-2fa.md)
  * [Address List](x-tokenization/examples/skills/address-list.md)
  * [BB-402 Token-Gated Access](x-tokenization/examples/skills/bb-402.md)
  * [Burnable](x-tokenization/examples/skills/burnable.md)
  * [Multi-Sig / Voting](x-tokenization/examples/skills/multi-sig-voting.md)
  * [Payment Protocol](x-tokenization/examples/skills/payment-protocol.md)
  * [Tradable NFTs](x-tokenization/examples/skills/tradable.md)
  * [Credit Token](x-tokenization/examples/skills/credit-token.md)
  * [Auto-Mint](x-tokenization/examples/skills/auto-mint.md)
...
* [📚 BitBadges API](for-developers/bitbadges-api/README.md)
  ...
  * [Enriched Simulate & Review](for-developers/bitbadges-api/enriched-simulate.md)
  * [Structured Error Messages](for-developers/bitbadges-api/structured-errors.md)

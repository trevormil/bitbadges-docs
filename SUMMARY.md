...
* [Approved Transactors](overview/approved-transactors.md)
...
* [🕸️ Gated Pages](for-developers/gated-pages.md)
* [🏗️ Claims / Plugins](overview/claim-builder/README.md)
  ...
  * [Plugins](for-developers/claim-builder/plugins/README.md)
    ...
    * [Creating a Custom Plugin](for-developers/claim-builder/plugins/creating-a-custom-plugin/README.md)
      ...
      * [Alternatives - Webhook URLs](for-developers/claim-builder/plugins/creating-a-custom-plugin/alternatives.md)
...
* [🔮 Gating Discord Servers](for-developers/badge-gating-discord-servers/README.md)
  * [Overview](for-developers/badge-gating-discord-servers/overview.md)
  * [Getting Server ID / Role IDs](for-developers/badge-gating-discord-servers/getting-server-id-role-ids.md)
  * [Role Assigner Plugin](for-developers/badge-gating-discord-servers/role-assigner-plugin.md)
  * [Self-Implementation](for-developers/badge-gating-discord-servers/self-implementation.md)

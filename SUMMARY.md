...
* [🏗️ Claims / Plugins](overview/claim-builder/README.md)
  ...
  * [Signed In vs Select Address](for-developers/claim-builder/signed-in-vs-select-address.md)
  ...
  * [BitBadges API & Claims](for-developers/claim-builder/bitbadges-api-and-claims/README.md)
    * [Fetching Claims](for-developers/claim-builder/bitbadges-api-and-claims/fetching-claims.md)
    * [Verifying Claim Attempts w/ API](for-developers/claim-builder/bitbadges-api-and-claims/verifying-claim-attempts-w-api.md)
    * [Complete Claims w/ BitBadges API](for-developers/claim-builder/bitbadges-api-and-claims/auto-complete-claims-w-bitbadges-api.md)
  * [Plugins](for-developers/claim-builder/plugins/README.md)
    * [Overview](for-developers/claim-builder/plugins/overview.md)
    * [Pre-Built Webhook Plugins](for-developers/claim-builder/plugins/alternatives.md)
  ...
  * [Tutorials](for-developers/claim-builder/other-tutorials/README.md)
    ...
    * [Payment Checking](for-developers/claim-builder/other-tutorials/monetizing-apps-badges.md)

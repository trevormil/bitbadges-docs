...
* [🎓 Learn](learn/README.md)
  ...
  * [Auto-Scan and Prioritized Approvals](learn/auto-scan-and-prioritized-approvals.md)
  * [Time-Dependent Accounting](learn/time-dependent-accounting.md)
* [🧠 Concepts](x-badges/concepts/README.md)
  * [Core Structures](token-standard/concepts/core-structures/README.md)
    * [Address Lists](token-standard/concepts/core-structures/address-lists.md)
    * [Collections](token-standard/concepts/core-structures/badge-collections.md)
    * [Balances](token-standard/concepts/core-structures/balance-system.md)
    * [UintRanges](token-standard/concepts/core-structures/uintrange.md)
    * [Timeline System](token-standard/concepts/core-structures/timeline-system.md)
    * [Different Time Fields](token-standard/concepts/core-structures/time-fields.md)
  * [Collection Configuration](x-badges/concepts/collection-setup-fields.md)
  ...
  * [Permissions](x-badges/concepts/permissions/README.md)
    ...
    * [Token ID Action Permissions](token-standard/concepts/permissions/token-id-action-permissions.md)

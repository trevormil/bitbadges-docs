...
* [🏗️ Claims / Plugins](overview/claim-builder/README.md)
  ...
  * [Concepts](for-developers/claim-builder/concepts/README.md)
    ...
    * [Completion Methods](for-developers/claim-builder/concepts/completion-methods.md)
    ...
    * [Success Logic](for-developers/claim-builder/concepts/success-logic.md)
    * [Claim Links (URLs)](for-developers/claim-builder/concepts/claim-links.md)
  * [Design Decisions](for-developers/claim-builder/design-decisions/README.md)
    * [Design Considerations](for-developers/claim-builder/design-decisions/creating-maintaining-claims.md)
    * [Universal Approach - Claim Codes](for-developers/claim-builder/design-decisions/universal-approach-claim-codes.md)
  * [BitBadges API - Claims](for-developers/claim-builder/bitbadges-api-claims/README.md)
    * [Fetching Claims](for-developers/claim-builder/bitbadges-api-claims/fetching-claims-w-api.md)
    * [Complete Claims w/ BitBadges API](for-developers/claim-builder/bitbadges-api-claims/auto-complete-claims-w-bitbadges-api.md)
    * [Verifying Claim Attempts w/ API](for-developers/claim-builder/bitbadges-api-claims/verifying-claim-attempts-w-api.md)
  * [Plugins](for-developers/claim-builder/plugins/README.md)
    ...
    * [Dynamic Stores](for-developers/claim-builder/plugins/dynamic-stores/README.md)
      * [Overview](for-developers/claim-builder/plugins/dynamic-stores/overview.md)
      * [Creating a Store](for-developers/claim-builder/plugins/dynamic-stores/creating-a-store.md)
      * [Attaching a Store](for-developers/claim-builder/plugins/dynamic-stores/attaching-a-store.md)
      * [Adding Data](for-developers/claim-builder/plugins/dynamic-stores/adding-data.md)

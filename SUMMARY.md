...
* [🖱️ Authenticating with BitBadges](for-developers/authenticating-with-bitbadges/README.md)
  * [Authentication URL + Parameters](for-developers/authenticating-with-bitbadges/authentication-url-+-params.md)
  ...
  * [Verification](for-developers/authenticating-with-bitbadges/verification.md)
  ...
  * [Additional Steps](for-developers/authenticating-with-bitbadges/additional-steps/README.md)
    ...
    * [Spreadsheet Session Management](for-developers/authenticating-with-bitbadges/additional-steps/spreadsheet-session-management.md)
  * [Verifiable Secrets](for-developers/core-concepts/verifiable-secrets/README.md)
    * [Creating a Secret](for-developers/core-concepts/verifiable-secrets/creating-a-secret.md)
    * [Creating and Verifying a Proof](for-developers/core-concepts/verifiable-secrets/creating-and-verifying-a-proof.md)
    * [Presentations](for-developers/core-concepts/verifiable-secrets/presentations.md)
  * [Badge-Gating Discord Servers](for-developers/tutorials/badge-gating-discord-servers.md)
  * [Self-Implementation Helpers](for-developers/authenticating-with-bitbadges/digital-sign-in-with-bitbadges.md)

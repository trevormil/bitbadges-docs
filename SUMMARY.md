...
* [🏗️ BitBadges Claims](overview/claim-builder/README.md)
  ...
  * [Integrate with Zapier](for-developers/claim-builder/automate-w-zapier/README.md)
  ...
  * [Other](for-developers/claim-builder/other/README.md)
    * [Get Discord Server ID](overview/claim-builder/discord.md)
    * [Build a Distribution Tool](for-developers/claim-builder/other/build-a-distribution-tool.md)

...
* [🏗️ BitBadges Claims](for-developers/claim-builder/README.md)
  * [Overview](for-developers/claim-builder/overview.md)
  * [Custom Claim Builder API Plugin](for-developers/claim-builder/using-the-claim-builder-api-plugin.md)
  * [Create an Approval w/ Claim Codes](for-developers/claim-builder/create-a-secret-code-based-approval.md)
  * [Build a Distribution Tool](for-developers/claim-builder/build-a-distribution-tool.md)
  * [Automate BitBadges Claims with Zapier](for-developers/claim-builder/automate-w-zapier/README.md)
    * [Overview](for-developers/claim-builder/automate-w-zapier/overview.md)
    * [Distribute Claim Information Tutorial](for-developers/claim-builder/automate-w-zapier/distribute-claim-information-tutorial.md)
    * [Automatic Claim Tutorial](for-developers/claim-builder/automate-w-zapier/automatic-claim-tutorial.md)
  * [Other](for-developers/claim-builder/other/README.md)
    * [Discord](for-developers/claim-builder/other/discord.md)

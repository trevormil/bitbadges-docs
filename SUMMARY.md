...
* [🔐 Verifiable Secrets](for-developers/verifiable-secrets/README.md)
  * [Creating a Secret](for-developers/verifiable-secrets/creating-a-secret.md)
  * [Creating and Verifying a Proof](for-developers/verifiable-secrets/creating-and-verifying-a-proof.md)
  * [Presentations](for-developers/verifiable-secrets/presentations.md)
...
* [📚 BitBadges API](for-developers/bitbadges-api/README.md)
  ...
  * [Routes](for-developers/bitbadges-api/routes/README.md)
    * [Collections](for-developers/bitbadges-api/routes/collections.md)
    * [Claims](for-developers/bitbadges-api/routes/claims.md)
    * [Auth Codes](for-developers/bitbadges-api/routes/auth-codes.md)
    * [Accounts](for-developers/bitbadges-api/routes/accounts.md)
    * [Authentication](for-developers/bitbadges-api/routes/authentication.md)
    * [Address Lists](for-developers/bitbadges-api/routes/address-lists.md)
    * [Protocols](for-developers/bitbadges-api/routes/protocols.md)

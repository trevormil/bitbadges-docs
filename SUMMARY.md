...
* [🧠 Core Concepts](overview/how-it-works/README.md)
  ...
  * [Verifiable Secrets](overview/how-it-works/verifiable-secrets.md)
...
* [🖱️ Authenticating with BitBadges](for-developers/authenticating-with-bitbadges/README.md)
  * [Authentication URL + Parameters](for-developers/authenticating-with-bitbadges/authentication-url-+-parameters/README.md)
    * [Metadata](for-developers/authenticating-with-bitbadges/authentication-url-+-parameters/metadata.md)
    * [Challenge Parameters](for-developers/authenticating-with-bitbadges/authentication-url-+-parameters/challenge-parameters.md)
    * [Verification Options](for-developers/authenticating-with-bitbadges/authentication-url-+-parameters/verification-options.md)
    * [Server-Side Verification](for-developers/authenticating-with-bitbadges/authentication-url-+-parameters/server-side-verification.md)
    * [Secrets Proofs](for-developers/authenticating-with-bitbadges/authentication-url-+-parameters/secrets-proofs.md)
  * [Approaches](for-developers/authenticating-with-bitbadges/approaches/README.md)
    * [No Callback](for-developers/authenticating-with-bitbadges/approaches/no-callback.md)
    * [Sign In with BitBadges Callback](for-developers/authenticating-with-bitbadges/approaches/sign-in-with-bitbadges-callback.md)
    * [Manual Callback](for-developers/authenticating-with-bitbadges/approaches/manual-callback.md)
  * [Additional Steps](for-developers/authenticating-with-bitbadges/additional-steps/README.md)
    * [Session Handling](for-developers/authenticating-with-bitbadges/additional-steps/session-handling.md)
    * [Secrets Contents](for-developers/authenticating-with-bitbadges/additional-steps/secrets-contents.md)
  * [Self-Implementation Helpers](for-developers/authenticating-with-bitbadges/self-implementation-helpers.md)
  * [🔐 Verifiable Secrets](for-developers/authenticating-with-bitbadges/verifiable-secrets/README.md)
    * [Creating a Secret](for-developers/authenticating-with-bitbadges/verifiable-secrets/creating-a-secret.md)
    * [Creating and Verifying a Proof](for-developers/authenticating-with-bitbadges/verifiable-secrets/creating-and-verifying-a-proof.md)
    * [Presentations](for-developers/authenticating-with-bitbadges/verifiable-secrets/presentations.md)
  * [Badge-Gating Discord Servers](for-developers/authenticating-with-bitbadges/badge-gating-discord-servers.md)
...
* [🧑‍🏫 Tutorials](for-developers/tutorials/README.md)
  * [Automate w/ Zapier](for-developers/tutorials/automate-w-zapier.md)

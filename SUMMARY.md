...
* [🖱️ Authenticating with BitBadges](for-developers/authenticating-with-bitbadges/README.md)
  ...
  * [Approaches](for-developers/authenticating-with-bitbadges/approaches/README.md)
    ...
    * [Self-Implemented Callback](for-developers/authenticating-with-bitbadges/approaches/self-implemented-callback.md)
  * [Verification](for-developers/authenticating-with-bitbadges/verification/README.md)
    * [Secrets Contents](for-developers/authenticating-with-bitbadges/verification/secrets-contents.md)
    * [Spreadsheet Session Management](for-developers/authenticating-with-bitbadges/verification/spreadsheet-session-management.md)

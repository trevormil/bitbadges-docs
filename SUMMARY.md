...
-   [🎓 Learn](learn/README.md)
    -   [📔 Pre-Readings](learn/pre-readings.md)
    ...
    -   [⚠️ Problems With Existing Standards](learn/problems-with-existing-standards.md)
    -   [🎯 Key Design Decisions](learn/key-design-decisions.md)
    -   [🔐 Permissions](learn/permissions.md)

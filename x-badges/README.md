...
Also note that we recommend the best way to learn is to just experiment or browse examples first, then revisit concepts which you may have questions about later. On the BitBadges site, the transaction submission modal will always have a "Show Tx" tab where you can see the full JSON.&#x20;

The easiest way to experiment is with the friendly no-code, in-site form and see what the JSON looks like via "Show Tx".

...
**BitBadges can be described as tokenization-as-a-service. We offer an open-source, state-of-the-art, community-driven suite of tools that enable you to create, customize, verify, and integrate with digital blockchain tokens. Our goal is to simply build an ever-evolving token standard and accompanying tools that can be used by anyone for any purpose.**

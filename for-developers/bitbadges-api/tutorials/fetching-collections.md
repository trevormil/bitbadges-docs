...
console.log(collection.getBadgeBalanceInfo('bb1....') //returns whole doc w/ approvals and more not just balances
```
...
```typescript
await collection.fetchBadgeBalances(BitBadgesApi, 'bb1....');
```

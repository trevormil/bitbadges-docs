...
First, read [Permissions](../../../overview/learn-the-basics/badge-concepts/manager.md) for an overview.

Note: The [Approved Transfers](../balances-transfers/transferability-approvals.md) and [Permissions ](../../../overview/learn-the-basics/badge-concepts/manager.md)are the most powerful features of the interface, but they can also be the most confusing. Please ask for help if needed.

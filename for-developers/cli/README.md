...
|-----------|---------|---------|
| **Create a collection with no wallet setup** | `bitbadges-cli broadcast-with-hot-wallet` | `bitbadges-cli builder templates subscription … \| bitbadges-cli broadcast-with-hot-wallet --msg-stdin --manager bb1… --local` |
...
- [Broadcast With Hot Wallet](broadcast-with-hot-wallet.md) — ship a create-collection tx without bringing your own wallet

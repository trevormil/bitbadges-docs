...
Configuration tools are a helper layer abstracted over the core pugin implementations. Instead of creating new, individual plugins for each use case, you can often reuse existing ones. For example, Google Calendar can be implemented by configuring the Email plugin with the attendee emails.

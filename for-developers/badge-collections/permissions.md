...
Note that we also reserve the "!" prefix for inverting a given mapping ID and also reserve specific mapping IDs (see [Address Mappings](../core-concepts/address-mappings-lists.md)).

...
First, read [Transferability ](../../../overview/how-it-works/badge-concepts/transferability.md)for an overview of approved transfers.

Note: The [Approved Transfers](transferability-approvals.md) and [Permissions ](../../../overview/how-it-works/badge-concepts/manager.md)are the most powerful features of the interface, but they can also be the most confusing. Please ask for help if needed.

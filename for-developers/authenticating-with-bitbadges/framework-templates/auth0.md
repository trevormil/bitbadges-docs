...
Out of the box, this does not have support for any custom features like ownership requirements, attestations, etc. For that, you will need to create a custom connection with those parameters hardcoded in the URLs where needed.

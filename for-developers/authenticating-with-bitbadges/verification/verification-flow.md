...
{% content-ref url="../../claim-builder/bitbadges-api-claims/verifying-claim-attempts-w-api.md" %}
[verifying-claim-attempts-w-api.md](../../claim-builder/bitbadges-api-claims/verifying-claim-attempts-w-api.md)
{% endcontent-ref %}

...
The metadata details depend on the type of badge collection or [Standard](../../for-developers/concepts/standards.md) that the collection implements. The default metadata standard we use is the following:

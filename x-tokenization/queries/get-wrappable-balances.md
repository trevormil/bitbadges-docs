...
```bash
# CLI query
bitbadgeschaind query tokenization get-wrappable-balances [denom] [address]

# Example with static denom
bitbadgeschaind query tokenization get-wrappable-balances "badges:1:mytoken" "bb1..."

# Example with dynamic denom (where 123 is the token ID)
bitbadgeschaind query tokenization get-wrappable-balances "badgeslp:1:token123" "bb1..."
```
...
```bash
# REST API
curl "https://lcd.bitbadges.io/bitbadges/bitbadgeschain/tokenization/get_wrappable_balances?denom=badges:1:mytoken&address=bb1..."
```

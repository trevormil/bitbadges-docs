...
The `ERC3643Tokenization.sol` contract provides an ERC-3643 compliant interface that wraps the precompile.

### Usage Example

```solidity
// Deploy the contract with a collection ID
ERC3643Tokenization token = new ERC3643Tokenization(1);
